...
const App: React.FC = () => {
  ...
  const getButtonClass = (tool: 'image' | 'video') => {
    const baseClass = "flex items-center justify-center w-full px-4 py-2 text-sm font-medium transition-colors duration-200 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-cyan-500";
    if (activeTool === tool) {
  ...
  return (
    <div className="min-h-screen text-gray-100 font-sans">
      <header className="bg-gray-900/50 backdrop-blur-lg border-b border-white/10 sticky top-0 z-20">
